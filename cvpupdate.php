...
$dat= mysqli_query($con,"select * from category");
                                    ...
                                    <tfoot>
                                            <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="product_name" placeholder="PRODUCT NAME" class="form-control form-control-user shadow-lg my-2">
                                                    </td>
                                                    <td>
                                                        <select name="category_id" class="shadow-lg my-2">
                                                            <?php
                                                            while($r=mysqli_fetch_assoc($dat)){
                                                                ?>
