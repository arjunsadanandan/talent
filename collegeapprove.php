                                    ...
                                    <tfoot>
                                            <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="collegeapprove.php?id=<?php echo$row['status']?>" name="submit" class="btn btn-outline-success"type="button">APPROVED</a>
                                                    <a href="collegereject.php?id=<?php echo$row['status']?>" name="submit" class="btn btn-outline-primary"type="button">REJECTED</td>
                                                    <td><a href="cvpdelete.php?id=<?php echo$row['product_id']?>" name="del" class="btn btn-outline-danger"type="button">DELETE</a></td>
                                                </tr>
                                                    <?php
                                                }
                                                ?>
