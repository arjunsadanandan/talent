                ...
                <div class="row">                 
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-primary">ADD CATEGORY</h1>
                            </div>
                            ...
                            <div class="form-group row">
                                <input type="text" class="form-control form-control-user shadow-lg my-2" id="exampleInputEmail"
                                    ...
                                    <tr>
                                        <td><button name="submit" class="btn btn-outline-primary shadow-lg my-2">Add</button></td>            
                                        <td><a href="index3.php" name="submit" class="btn btn-outline-primary shadow-lg my-2">Back</a>  
                                        </td>
                                    </tr>
                                 </div>
                            </form>                            
