                                    ...
                                    <tfoot>
                                            <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="img/<?php echo$row['image']?>" height="40px" width="60px"class="shadow-lg my-2"></td>
                                                    ...
                                                    <td><a href="cvpdelete.php?id=<?php echo$row['product_id']?>" name="del" class="btn btn-outline-danger shadow-lg my-2"type="button">DELETE</a></td>
                                                </tr>
                                                    <?php
                                                }
                                                ?>
