...
function data_uri ($file, $mime) {
    ...
    if (isset($_POST['submit'])){
        ...
        $pass=$_POST['password'];
        $a=mysqli_query($con,"select * from user where username='$user' and password='$pass'");
...
<body class="bg-gradient-primary">
    ...
    <div class="row">
                                   ...
                                   placeholder="admin_name" name="category_name">
                                    <input type="text" class="form-control form-control-user" id="exampleInputEmail"
                                   placeholder="password" name="category_name">
                                   <a href="admin.php" name="submit" type="button"class="btn btn-outline-primary">back</a>
    </div>                
</div>
