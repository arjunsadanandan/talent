        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-primary">NOTIFICATION</h1> 
                    </div>
                        <div class="card-body">
                                    ...
                                    <tfoot>
                                            <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="adminvdelete.php?id=<?php echo$row['notification_id']?>" name="submit" class="btn btn-outline-danger shadow-lg my-2">DELETE</a></td> 
                                                </tr>
                                                    <?php
                                                }
                                                ?>
