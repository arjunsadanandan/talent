...
$da = $_GET['id'];
$data= mysqli_query($con,"select * from product join category  ");
if(isset($_POST['submit'])){
    $category=$_POST['category_name'];
    $product=$POST['product_name'];
    $price=$_POST['price'];
    mysqli_query($con,"update product set category_name='$category',product='$product',price='$price'");
                                    ...
                                    <tfoot>
                                            <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="" type=button name="submit" class="btn btn-outline-primary">Update</a></td>
