                                    ...
                                    <tfoot>
                                            <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="img/<?php echo$row['image']?>" height="60px" width="80px"class="shadow-lg my-2"></td>
                                                    <td><a href="delete.php?id=<?php echo$row['product_id']?>" name="delete" class="btn btn-outline-danger shadow-lg my-2"type="button">DELETE</a></td>
                                                </tr>
                                                    <?php
                                                }
                                                ?>
