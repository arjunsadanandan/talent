...
if (isset($_POST['submit'])){
    ...
    mysqli_query($con,"insert into product(student_name,category_name,product_name,price,status,image)values('$student','$categoryn','$product','$price','$status','$filenew')");
                ...
                <div class="row">
                        <div class="p-5">
                            ...
                            <form class="user" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <input type="file" class="form-control form-control-user shadow-lg my-2"
                                         name="image" >
                                </div>   
                                    <tr>
                                        <td>
